					...
					<div class="row ">
						...
						<div class="col-xl-9">
								...
								<div class="col">
									<div class="form-selectgroup">
										<label class="form-selectgroup-item">
											<input type="radio" name="cststatus" value="individual" class="form-selectgroup-input opt-status" checked="">
											<span class="form-selectgroup-label" style="font-weight: 500;padding: 6px 12px 3px 12px; ">
												<i class="ri-user-fill icon" style="font-size: 16px; vertical-align: middle; margin-right: 4px;"></i> Invidual
											</span>
										</label>
										<label class="form-selectgroup-item" style="">
											...
											<span class="form-selectgroup-label" style="font-weight: 500;padding: 6px 12px 3px 12px; ">
												<i class="ri-community-fill icon" style="font-size: 16px; vertical-align: middle; margin-right: 4px;"></i> Institution
											</span>
										</label>
									</div>
								</div>
							...
							<div class="mb-3 row" id="person-name-area">
								<label class="col-3 col-form-label custom-label">Person Names</label>
								<div class="col">
							...
							<div class="mb-3 row" id="institution-name-area">
								...
								<div class="col">
									<select type="text" class="form-select" name="institution_name" placeholder="Select companies" id="select-companies" value="">
										<option value="{{ null }}"></option>
										@foreach ($institution as $item)
										<option value="{{ $item->ins_id }}">{{ $item->ins_name }}</option>
										@endforeach
									</select>
								</div>
							</div>
							<div class="mb-3 row" id="institution-name-area">
								<label class="col-3 col-form-label custom-label">Customer Names</label>
								<div class="col">
									<select type="text" class="form-select" name="customer_name" placeholder="Select customer" id="select-customer" value="">
										<option value="{{ null }}"></option>
							...
							<div class="mb-3 row" id="institution-category-area" style="display: none;">
								<label class="col-3 col-form-label custom-label">Business Field Categories</label>
								<div class="col">
									<select type="text" class="form-select mb-3 select-categories" name="business_category" placeholder="Select business categories of company" id="select-category" value="">
										<option value="{{ null }}"></option>
...
<script>
/************************************************************************/
var select_companies = new TomSelect("#select-companies",{
	create: true,			
	valueField: 'id',
	labelField: 'title',
	searchField: 'title',
...
var select_option_view = new TomSelect("#select-option-view",{
	create: true,			
	valueField: 'id',
	labelField: 'title',
	searchField: 'title',
	render: {
		...
		item: function(data, escape) {
			return '<div id="select-option-view">'+escape(data.title)+'</div>';
		}
	}
});
...
select_companies.on('change',function () {
	var ins_id = select_companies.getValue();
	actionGetCustomer(ins_id);
});
