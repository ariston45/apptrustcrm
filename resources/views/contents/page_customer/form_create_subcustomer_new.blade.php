					...
					<div class="row">
						...
						<div class="col-xl-6">
							...
							<div class="mb-3 row" id="institution-category-area">
								...
								<div class="col">
									<select type="text" class="form-select select-categories" name="business_category" placeholder="Select business categories of company" id="select-category" value="">
