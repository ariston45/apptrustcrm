	...
	<div class="col-md-12 ">
		<div class="card" style="margin-bottom:150px;">
			<div class="card-header card-header-custom card-header-light">
				<h3 class="card-title">Create Opportunity</h3>
				<div class="card-actions" style="padding-right: 10px;">
					...
					<a href="{{ url('customer/detail-customer-opportunities') }}/{{ $id_cst }} ?extpg=opportunities">
			...
			<form id="formContent1" enctype="multipart/form-data" action="javascript:void(0)" method="Get" autocomplete="off">
				...
				<div class="card-body card-body-custom">
					<div class="row mb-2">
						<div class="col-xl-6">
							{{-- <input name="lead_title" id="lead-title" type="hidden" class="form-control mb-2" value="{{ $id_cst }}" readonly> --}}
							<div class="mb-3 row">
								<label class="col-4 col-form-label custom-label" style="text-align: right;">Project Name</label>
								<div id="select-project-area" class="col">
									<select type="text" class="form-select" name="lead_id" id="select-project" value="" placeholder="Select project">
										<option value="{{ null }}"></option>
										@foreach ($project as $list)
											<option value="{{ $list->lds_id }}">{{ $list->lds_title }}</option>
										@endforeach
									</select>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div id="multiInputPhone" class="col">
									<div class="input-group">
										<input name="est_closing_date" id="est-closing-date" type="text" class="form-control">
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-6">
							...
							<div class="mb-3 row">
								<label class="col-4 col-form-label custom-label required">Set Product</label>
								<div class="col">
							...
							<div class="mb-3 row">
								<label class="col-4 col-form-label custom-label">Count</label>
								<div class="col">
...
{{-- Selection Input --}}
<script>
	var select_customer = new TomSelect("#select-project",{
		create: false,			
		valueField: 'id',
		labelField: 'title',
		searchField: 'title',
...
$(document).ready(function() {
	$("#formContent1").submit(function(e) {
		...
		$.ajax({
			type: "POST",
			url: "{{ route('store-new-opportunity-cst') }}",
			data: formData1,
			cache: false,
			contentType: false,
			processData: false,
