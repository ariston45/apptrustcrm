	...
	<div class="card-body pt-3" style="padding-left: 10px;padding-right: 10px;">
		<div class="col-12">
			<div id="init-page-activities" class="row mb-2">
				<em class="col text-muted lh-base mb-1"><i>Tikets</i></em>
				<div class="col-auto">
							...
							<div class="mb-2 row" style="margin-right: 0px;">
								...
								<div class="col" style="padding: 0px;">
									<select type="text" id="select-assign-user" class="form-select ts-input-custom" name="assignment_user" placeholder="User assignment..."  value="">
										@foreach ($user_technical as $list)
										@if ( $user->id == $list->id)
					...
					<div class="row">
						<div class="col-xl-12">
							<div class="mb-2" style="margin-right: 0px;">
								<label class="col-12 col-form-label">Describe Ticket</label>
								<textarea id="notesActivitiesDes" name="activity_describe"></textarea>
							</div>
							<div class="mb-2" style="margin-right: 0px;">
								<label class="col-12 col-form-label">Result Ticket</label>
...
function sourceDataActivityCalender(start,end) {
	...
	$.ajax({
		type: 'POST',
		url: "{{ route('source-data-activity-calender-tck') }}",
		async: false,
		data: {
			'start':start,
			'end':end
					...
					$.confirm({
						...
						buttons: {
							goToLead:{
								text:"Go To Ticket",
								action:function () {  
									window.location.href = "{{ url('ticket/ticket-detail') }}/"+result.idactivity;
								}
							},
							createAgain:{
								text:"Create Again",
