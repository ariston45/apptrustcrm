	...
	<div class="card-body pt-2" style="padding-left: 10px;padding-right: 10px;">
		<div class="row mb-0">
			<div class="col-12 mb-2">
				<div class="row">
					<div class="col-12">
						<label class="form-label text-muted pb-0 pt-0">Describe Ticket</label>		
					</div>
				</div>
				<div class="row">
					<div class="col">
		...
		<div class="row mb-0">
			<div class="col-12 mb-2">
				<div class="row">
					<div class="col-12">
						<label class="form-label text-muted pb-0 pt-0">Result Tiket</label>		
					</div>
				</div>
				<div class="row">
					<div class="col">
	...
	<div class="card-body pt-2" style="padding-left: 10px;padding-right: 10px;">
		...
		<div class="row">
			<div class="col-12">
				...
				<button href="#area-action" class="btn btn-outline-blue btn-pill" onclick="actionCloseCreateAct()">Close And Create Ticket</button>
				<button href="#area-action" class="btn btn-outline-blue btn-pill" onclick="actionTicketCreateAct()">Create Ticket</button>
			</div>
		</div>
	</div>
</div>
...
<div id="modal-edit-activities" class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full-width-custom modal-dialog-centered mt-1" role="document">
		<div class="modal-content">
			<div class="modal-header" style="min-height: 2.5rem;padding-left: 1rem;">
				<h5 class="modal-title">Reschedule Ticket</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="height: 2.5rem;"></button>
			</div>
			<div class="modal-body p-3">
							...
							<div class="mb-2 row" style="margin-right: 0px;">
								...
								<div class="col" style="padding: 0px;">
									<select type="text" id="select-signed-user-i" class="form-select ts-input-custom" name="assignment_user" placeholder="User assignment..."  value="">
										...
										@if ($list->id == $main_activity->userid)
	...
	<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center py-4">
				...
				<h3>Are you sure?</h3>
				<div class="text-muted">Do you really want to close ticket?</div>
			</div>
			<div class="modal-footer">
				<div class="w-100">
					<div class="row">
						...
						<div class="col">
							<form id="formContent5" name="formContent5" enctype="multipart/form-data" action="javascript:void(0)" method="post">
								...
								<button type="submit" href="#" class="btn btn-sm bg-orange-lt w-100" data-bs-dismiss="modal"> Close Ticket</button>
							</form>
						</div>
					</div>
				</div>
