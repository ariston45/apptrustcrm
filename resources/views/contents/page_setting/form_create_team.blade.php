	...
	<div class="col-md-12 ">
		<div class="card" style="margin-bottom:150px;">
			<div class="card-header card-header-custom card-header-light">
				<h3 class="card-title">Form Create Team</h3>
						...
						<div class="col-xl-6">
							<div class="mb-3 row">
								...
								<div id="select-customer-area" class="col">
									<input name="team" id="id-team" type="text" class="form-control">
								</div>
							</div>
							<div class="mb-3 row">
							...
							{{-- <div class="mb-3 row">
								...
								<div id="select-customer-area" class="col">
									<input name="mobile" id="user-mobile" type="text" class="form-control">
								</div>
							</div>
							<div class="mb-3 row">
								<label class="col-4 col-form-label custom-label" style="text-align: right;">Email</label>
								<div id="select-customer-area" class="col">
									<input name="email" id="user-email" type="text" class="form-control">
								</div>
							</div>
							<div class="mb-3 row">
